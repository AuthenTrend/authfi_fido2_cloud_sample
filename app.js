...
app.post('/api/register', async (req, res) => {
    try {
        let result = await webauthn.doRegisterOption(req.body.email, req.body.name);
        res.json(result);
    } catch(err) {
...
app.post('/api/login', async (req, res) => {
    try {
        let result = await webauthn.loginOption();
        res.json(result);
    } catch(err) {
...
app.post('/api/identity', async (req, res) => {
    try {
        let result = await webauthn.verifyOption(req.body.email);
        res.json(result);
    } catch(err) {
...
app.get('/api/localUsers', async (req, res) => {})
